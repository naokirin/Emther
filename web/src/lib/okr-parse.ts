...
const FEW_SHOT_EXAMPLES: Array<{ user: string; assistant: string }> = [
  {
    user: [
      "# Objective 1：【Sales】売上を昨対比150%にする",
      "",
      "- Key Result 1：新規獲得施策のリリースが完了している",
      "    1. 初回クーポン",
      "    2. SNS連携",
      "- Key Result 2：レコメンド精度が向上している",
      "    - ムーンショットとして設定",
      "",
    ...
    assistant: JSON.stringify({
      objectives: [
        ...
        {
          title: "【Delivery】配送プロセスを最適化する",
          note: "",
          keyResults: ["提携配送業者との連携を強化できている"],
        },
      ],
    }),
  },
