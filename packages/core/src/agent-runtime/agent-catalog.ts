import { EXEC_AGENT_NAME } from "../types";
...
export const ROLE_BLOCKS: Record<string, string[]> = {
  ...
  "Process Agent": [
    ...
    "- 効きやすい哲学レンズ（参考。他のレンズを使ってもよい）: Lean（Flow・待ち・滞留・ムダ・制約）",
  ],
  "Tech Agent": [
    "【役割】",
