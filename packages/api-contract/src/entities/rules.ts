...
// 必須スカラーは列挙。agentModelTiers 等の Partial マップは passthrough 側で許容。
export const rulesAndConstraintsSchema: z.ZodType<RulesAndConstraints> = z
  .object({
  ...
  .passthrough() as z.ZodType<RulesAndConstraints>;
